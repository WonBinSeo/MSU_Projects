...
rw = ["0"]*8+["1"]*8
rfen = ["0"]*2+["1"]*1+["0"]*3+["1"]*1+["0"]*3+["1"]*1+["0"]*3+["1"]*1+["0"]*1

clk1 = ["1"]*1+["0"]*3+["1"]*1+["0"]*3+["1"]*1+["0"]*3+["1"]*1+["0"]*3
clk2 = ["0"]*2+["1"]*1+["0"]*3+["1"]*1+["0"]*3+["1"]*1+["0"]*3+["1"]*1+["0"]*1

F0 = ["0"]*2+["1"]*2+["0"]*2+["1"]*2+["0"]*2+["1"]*2+["0"]*2+["1"]*2
F1 = ["0"]*2+["0"]*2+["1"]*2+["1"]*2+["0"]*2+["0"]*2+["1"]*2+["1"]*2
F2 = ["0"]*8+["1"]*8
F3 = ["0"]*8
F8 = ["0"]*8
F5 = ["0"]*8
...
inputs = [ada0, ada1, ada2, adb0, adb1, adb2, md0, md1, md2, md3, md8, md5, md6, md7, rw, rfen, rfs, clk1, clk2, F0, F1, F2, F3, F8, F5, F6]

inputNames = ["ada0", "ada1", "ada2", "adb0", "adb1", "adb2", "md0", "md1", "md2", "md3", "md4", "md5", "md6", "md7", "rw", "rfen", "rfs", "clk1", "clk2", "F0", "F1", "F2", "F3", "F4", "F5", "F6"]
